...
uses
  Classes, {$IFDEF GLS_DELPHI_6_UP}Variants,{$ENDIF} dws2Exprs, dws2Symbols, dws2Comp;
...
uses
  dws2Functions, OpenGL1x, VectorGeometry;
...
type
  ...
  TglMultiTexCoord1fARB = class(TInternalFunction)
  public
    procedure Execute; override;
  end;

  TglMultiTexCoord2fARB = class(TInternalFunction)
  public
    procedure Execute; override;
  end;

  TglMultiTexCoord3fARB = class(TInternalFunction)
  public
    procedure Execute; override;
  end;

  TglMultiTexCoord4fARB = class(TInternalFunction)
  public
    procedure Execute; override;
  end;

  TglActiveTextureARB = class(TInternalFunction)
  public
    procedure Execute; override;
  end;

  TglClientActiveTextureARB = class(TInternalFunction)
  public
    procedure Execute; override;
  end;
...
procedure Register;
begin
  RegisterComponents('GLScene DWS2', [Tdws2OpenGL1xUnit]);
end;
...
procedure Tdws2OpenGL1xUnit.AddUnitSymbols(SymbolTable: TSymbolTable);
var
  CardinalSymbol,
  ByteSymbol : TSymbol;
begin
...
// ----------
// ---------- TglMultiTexCoord1fARB ----------
// ----------

procedure TglMultiTexCoord1fARB.Execute;
var
  target : Cardinal;
  s : Single;
begin
...
// ----------
// ---------- TglMultiTexCoord2fARB ----------
// ----------

procedure TglMultiTexCoord2fARB.Execute;
var
  target : Cardinal;
  s, t : Single;
begin
...
// ----------
// ---------- TglMultiTexCoord3fARB ----------
// ----------

procedure TglMultiTexCoord3fARB.Execute;
var
  target : Cardinal;
  s, t, r : Single;
begin
...
// ----------
// ---------- TglMultiTexCoord4fARB ----------
// ----------

procedure TglMultiTexCoord4fARB.Execute;
var
  target : Cardinal;
  s, t, r, q : Single;
begin
...
procedure TglActiveTextureARB.Execute;
var
  target : Cardinal;
begin
  target:=Info['target'];
...
// ----------
// ---------- TglClientActiveTextureARB ----------
// ----------

procedure TglClientActiveTextureARB.Execute;
var
  target : Cardinal;
begin
  target:=Info['target'];
