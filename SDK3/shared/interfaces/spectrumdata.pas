...
uses
  Classes, SysUtils, PluginType, VPBuffers, StdParamTypes;
...
type
  ...
  ISpectrumData2       = interface (ISpectrumData{IBasicFFTSpectrumData})
    ['{974AD445-717A-4CC8-8734-90FBCEC638A9}']
    function GetBeatPos: MVFloat; stdcall;
    property BeatPos: MVFloat read GetBeatPos;
  end;

  ISpectrumData3       = interface (ISpectrumData2)
...
var
  AdvSpectrumData: ISpectrumData3;
