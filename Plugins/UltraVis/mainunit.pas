...
begin
  ...
  with PluginSystem do begin
    RegisterVis('SpreadGobo','SPREADGO', @procVisGobo, ['1. Gobofarbe Innen','2. Gobofarbe Innen','1. Gobofarbe Außen','2. Gobofarbe Außen','Größe','Anzahl','Grenzwert','Streckfaktor','Maximalradius (in %)','Absinkfaktor'], [VColor,VInteger,VInteger,vReal,vReal,vReal,vReal],[nil,nil,@ChangeGoboParams],SpreadGoboIV,[],[],sizeof(TSpreadGoboWSRec),@InitGobo,@FreeGobo);
