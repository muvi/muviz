...
function TCommandList.FindCommand(const ACommand: string): Integer;
var
...
begin
  I:=Length(FCommands);
  SetLength(FCommands,I+1);
  if I>0 then while FCommands[I-1].Command>ACommand do begin
    FCommands[I]:=FCommands[I-1];
    Dec(I);
    if I=0 then break;
  end;
  with FCommands[I] do begin
    Command:=ACommand;
