...
type
  ...
  public
    ...
    //for debugging only
    property ItemsOrNil[AID: TTVSPSrcID]: ITVSPSource read GetSourceOrNil; deprecated;
...
function TTVSPClientSources.GetSourceOrNil(AID: TTVSPSrcID): ITVSPSource; cdecl;
begin
  Result:=GetItemOrNil(AID.Size, AID.ID);
end;
